...
import static cn.hang.core.util.Collections.isEmpty;
...
public final class Classes {
    ...
    public static String getShortName(String className) {
        checkState(!Strings.isNullOrEmpty(className), "Class name must not be empty");
    ...
    public static String getShortNameAsProperty(Class<?> clazz) {
        String shortName = Classes.getShortName(clazz);
    ...
    public static String getPackageName(String fqClassName) {
        checkNotNull(fqClassName, "Class name must not be null");
    ...
    private static String getQualifiedNameForArray(Class<?> clazz) {
        ...
        while (clazz.isArray()) {
            ...
            result.append(Classes.ARRAY_SUFFIX);
        }
            ...
            try {
                if (Modifier.isPublic(method.getModifiers())) {
                    ...
                    Method specificMethod =
                            Reflections.findMethod(targetClass, method.getName(), method.getParameterTypes());
    ...
    public static boolean isAssignable(Class<?> lhsType, Class<?> rhsType) {
        checkNotNull(lhsType, "Left-hand side type must not be null");
        checkNotNull(rhsType, "Right-hand side type must not be null");
    ...
    public static String addResourcePathToPackagePath(Class<?> clazz, String resourceName) {
        checkNotNull(resourceName, "Resource name must not be null");
    ...
    public static String classNamesToString(Collection<Class> classes) {
        if (cn.hang.core.util.Collections.isEmpty(classes)) {
            return "[]";
        }
    ...
    public static Class<?> createCompositeInterface(Class<?>[] interfaces, ClassLoader classLoader) {
        boolean state = ArraysUtils.isNotEmpty(interfaces);
        checkState(state, "Interfaces must not be empty");
    ...
    public static boolean isCglibProxy(Object object) {
        return Classes.isCglibProxyClass(object.getClass());
    }
